    ...
    return (
        <div className="space-y-12 animate-fade-in">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <section className="bg-cde-bg-light border border-cde-border p-6 rounded-lg flex flex-col items-center justify-center min-h-[400px]">
                    <h3 className="text-xl tracking-widest uppercase mb-6 self-start w-full border-b border-cde-border pb-4">Tus Atributos</h3>
                ...
                <section className="space-y-6">
                    <div className="bg-cde-bg-light border border-cde-border p-6 rounded-lg">
                        <h3 className="text-lg tracking-widest uppercase mb-4 border-b border-cde-border pb-2">Nivel General</h3>
                        <div className="flex items-end gap-4 mb-2">
                            <span className="text-5xl font-bold text-cde-text">Lv. {Math.round((constancia + productividad) / 20) + 1}</span>
                            <span className="text-cde-text-muted mb-1 tracking-widest uppercase">Arquitecto de Sistemas</span>
                        </div>
                        <p className="text-sm text-cde-text-muted">Sigue completando tareas y hábitos para ganar EXP.</p>
                    </div>

                    <div className="bg-cde-bg-light border border-cde-border p-6 rounded-lg">
                        <h3 className="text-lg tracking-widest uppercase mb-4 border-b border-cde-border pb-2">Métricas Clave</h3>
                        <div className="space-y-4">
                            <div>
                                ...
                                <div className="w-full bg-cde-bg-lighter h-2 rounded-full overflow-hidden">
                                    <div className="h-full bg-cde-text" style={{ width: `${productividad}%` }}></div>
                                </div>
                            </div>
                            <div>
                                <div className="flex justify-between text-sm mb-1">
                                ...
                                <div className="w-full bg-cde-bg-lighter h-2 rounded-full overflow-hidden">
                                    <div className="h-full bg-cde-text" style={{ width: `${constancia}%` }}></div>
                                </div>
                            </div>
                        </div>
                    </div>
